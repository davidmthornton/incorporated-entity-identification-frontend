...
## Header Links
header.links.sign_out                                       = Allgofnodi
...
capture-ctutr.error.incorrect-format                        = Mae’n rhaid i Gyfeirnod Unigryw y Trethdalwr ar gyfer y cwmni fod yn 10 rhif
...
ctutr-not-found.line_3c                                     = rhoi gwybod iddynt fod problem gyda’ch Cyfeirnod Unigryw y Trethdalwr.
ctutr-not-found.line_4                                      = Os gwnaethoch ddefnyddio’r manylion anghywir, gallwch
ctutr-not-found.line_4_link                                 = roi cynnig arall arni gan ddefnyddio manylion gwahanol.
